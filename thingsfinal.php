...
if(isset($_POST["submit"]))
{
    ...
    $check = mysqli_query($conn,"insert into data(name,mobile,gender,department,itemdetail,image) values('$_POST[name]','$_POST[mobile]','$_POST[gender]','$_POST[department]','$_POST[itemdetail]','$dst_db')");  // executing insert query
