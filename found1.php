...
if(isset($_POST["submit"]))
{
    ...
    $check = mysqli_query($conn,"insert into data3(name,image,mobile,email,gender,department,location) values('$_POST[name]','$dst_db','$_POST[mobile]','$_POST[email]','$_POST[gender]','$_POST[department]','$_POST[location]')");  // executing insert query
