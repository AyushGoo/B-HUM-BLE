...
if(isset($_POST["submit"]))
{
    ...
    $check = mysqli_query($conn,"insert into data1(fname,email,mobile,gender,reason,image,amount) values('$_POST[fname]','$_POST[email]','$_POST[mobile]','$_POST[gender]','$_POST[reason]','$dst_db','$_POST[amount]')");  // executing insert query
		
    if($check)
    {
    	header('Location:AdminThings.php');
 // alert message
    }
    else
    {
