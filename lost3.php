...
if(isset($_POST["submit"]))
{
    ...
    $check = mysqli_query($conn,"insert into data2(name,image,mobile,email,gender,department,itemdetail) values('$_POST[name]','$dst_db','$_POST[mobile]','$_POST[email]','$_POST[gender]','$_POST[department]','$_POST[itemdetail]')");  // executing insert query
		
    if($check)
    {
    	header('Location:lost2.php');
 // alert message
    }
    else
    {
